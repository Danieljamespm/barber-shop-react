...
const Pricing = () => {
    ...
    const tabContent = {
        tab1: (
            <div className='flex justify-around flex-col md:flex-row'>
                <div className=' w-[100%] md:w-[45%]'>
                    ...
                    <div className='flex justify-between pt-3 pb-3 lg:pt-0 md:text-2xl'>
                    ...
                    <div className='flex justify-between pb-3 md:text-2xl'>
        ...
        tab2: (
            ...
            <div className=' w-[100%] md:w-[45%]'>
                ...
                <div className='flex justify-between pb-3 pt-3 md:pt-0 md:text-2xl'>
        ...
        tab3: (
            <div className='flex justify-around flex-col md:flex-row'>
                <div className=' w-[100%] md:w-[45%]'>
                    ...
                    <div className='flex justify-between pb-3 pt-3 lg:pt-0 md:text-2xl'>
  ...
  return (
        ...
        <div id="pricing" className='bg-black bg-blend-darken bg-opacity-70 bg-barber-chair bg-cover bg-center h-[600px] md:h-[750px] '>
            <h2 className='text-4xl md:text-6xl text-center font-oswald font-bold pt-20 pb-2 text-white'>OUR PRICING</h2>
            <img className='w-[80px] md:w-[150px] mx-auto pb-10' src='./barber-scissors.png' />
                <div className=' w-[80%] h-[50%] m-auto'>
               <div className='flex flex-wrap justify-around bg-black text-gray-500 text-xl md:text-4xl font-bold border-b-2 border-[#d19d64] '>
                {tabs.map((tab) => (
            ...
            <div className='h-[45px] max-w-[65%] hover:bg-black hover:border-white hover:duration-500 mx-auto p-12 border-2 border-gray-500 hidden md:flex justify-between items-center '>
                <p className='text-white font-oswald md:text-2xl'>OPENING HOURS: MONDAY-FRIDAY: 9.00AM-6.00PM</p>
                <button className='bg-[#D19D64] h-[30px] w-[180px] text-xs hover:bg-white hover:duration-500 rounded-lg font-oswald font-bold tracking-widest'>MAKE APPOINTMENT NOW</button>
            </div>
        </div>    
  )
}
