  ...
  return (
    <div id='aboutus' className='w-full bg-white py-10 px-4 scroll-smooth'>
        <div className='maw-w-[1240px] mx-auto grid md:grid-cols-2 font-oswald md:px-32'>
            ...
            <p className='text-[10px] text-[#bb9e86] py-2'>THE UNIQUE STORY</p>
        ...
        <button className='bg-[#bb9e86] text-black px-4 py-3 m-5 md:mx-32 text-[10px] hover:bg-black hover:text-[#bb9e86] hover:duration-500 rounded-lg font-bold tracking-widest'>READ MORE</button>
