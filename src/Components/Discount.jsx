...
const Discount = () => {
    ...
    return (
    <div className='bg-white h-[800px] flex justify-center pt-24'>
        ...
        <div className='h-[100%] bg-black w-[100%] m-auto flex justify-center items-center flex-col '>
            ...
            <p className='text-white text-3xl md:text-5xl font-oswald font-light'>ON EVERY SUNDAY OF DECEMBER</p>
