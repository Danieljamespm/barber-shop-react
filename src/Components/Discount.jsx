...
const Discount = () => {
    ...
    <div className='bg-white h-[800px] sm:h-[700px] md:h-[700px] flex justify-center pt-24'>
        ...
        <button className='bg-[#D19D64] p-4 md:p-3 md:m-6 m-10 mx-auto text-xs lg:text-xl hover:text-[#d19d64] hover:bg-black hover:duration-500 rounded-lg font-bold font-oswald tracking-wide'>MAKE AN APPOINTMENT NOW</button>
        </div>
        </div>
    </div>
  )
