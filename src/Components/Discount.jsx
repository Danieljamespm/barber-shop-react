...
const Discount = () => {
    ...
    <div className='bg-white h-[800px] sm:h-[700px] md:h-[700px] flex justify-center pt-24'>
        ...
        <div className='h-[100%] bg-black w-[100%] m-auto flex justify-center items-center flex-col '>
            <p className='text-[#D19D64] font-oswald text-3xl md:text-5xl font-bold'>GET FLAT 25% DISCOUNT</p>
            <p className='text-white text-2xl md:text-5xl font-oswald font-light'>ON EVERY SUNDAY OF DECEMBER</p>
            <p className='text-white font-oswald p-4 text-xl md:xl'>USE PROMO CODE: <span className='text-[#d19d64]'>VINTAGEBARBER</span></p>
        </div>
        <div className=' font-oswald text-md w-full text-center pt-10'>
        ...
        <button className='bg-[#D19D64] p-4 md:p-3 md:m-10 m-10 mx-auto text-xs hover:text-[#d19d64] hover:bg-black hover:duration-500 rounded-lg font-bold font-oswald tracking-wide'>MAKE AN APPOINTMENT NOW</button>
        </div>
        </div>
    </div>
  )
