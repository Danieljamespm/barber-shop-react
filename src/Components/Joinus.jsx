...
const Joinus = () => {
  return (
    <div id='joinus' className='w-full bg-black h-[200px] flex flex-col justify-center md:justify-evenly md:flex-row items-center font-oswald text-xl md:text-3xl'>
        ...
        <div>
        <button className='bg-[#D19D64] p-0 px-4 m-4 text-[9px] hover:text-black hover:bg-white hover:duration-500 rounded-lg font-oswald font-bold tracking-widest'>JOIN US</button>
        </div>
    </div>
