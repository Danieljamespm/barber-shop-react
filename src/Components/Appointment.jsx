  ...
  return (
    <div  id='appointment' className=' w-full h-[1100px] sm:h-[700px] bg-black text-white'>
        ...
        <div className='pb-4 w-full sm:w-[300px] '>
            ...
            <div className='w-[200px]  border-b border-dotted'></div>
            <p className='font-oswald text-xs font-light  pt-9'>CLOSED</p>
            </div>
        </div>
        <div className='bg-[#d19d64] w-full sm:w-[300px] md:w-[400px] pb-10'>
            <h3 className='font-oswald text-center pt-6 text-2xl font-bold'>BOOK NOW</h3>
            <img className='w-[50px] mx-auto' src='./barber-scissors.png' />
            <div>
